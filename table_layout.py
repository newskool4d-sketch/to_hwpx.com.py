...
from table_roles import DETAIL_HEADER_TERMS
from table_roles import SCHEDULE_COLUMN_WIDTHS
...
def table_layout_for(
    ...
    role_widths = _scale_widths(role_column_widths(role, col_count), col_count, total_width)
